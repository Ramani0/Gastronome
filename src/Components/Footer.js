...
const Footer = () => {
  return (
    <div>
        <footer>
  <div class="containera footerContainer">
...
cafés and bars in India
      ...
      <div class="col flex flex-column flex-g-1 flex-start">
        ...
        <nav class="col-list">
          ...
          <Link to="/Login2"><button type="button" class="btn btn-outline-dark">Admin</button></Link>
        </nav>
      </div>
    ...
    <div class="copyright">© 2024 – All Rights Reserved. (Ramani.R)</div>
  </div>
</footer>
